          ...
          <div className="flex justify-between h-20 items-center">
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0">
                <div className="text-2xl font-light text-white tracking-wider">ZAMANIX</div>
              </Link>
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link to="/wishlist" className="text-white/70 hover:text-white relative">
              ...
              <Link to="/cart" className="text-white/70 hover:text-white relative">
